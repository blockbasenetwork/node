...
{
    public class CheckRequesterConfig : AbstractCommand
    {
        ...
        public CheckRequesterConfig(ILogger logger, IMainchainService mainchainService, NodeConfigurations nodeConfigurations, NetworkConfigurations networkConfigurations, IConnectionsChecker connectionsChecker)
        {
