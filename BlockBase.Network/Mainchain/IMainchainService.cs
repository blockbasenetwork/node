...
namespace BlockBase.Network.Mainchain
{
    public interface IMainchainService
    {
        ...
        Task<string> AddReservedSeats(string chain, List<ReservedSeatsTable> seatsToAdd);
        ...
        Task<string> ConfigureChain(string owner, Dictionary<string, object> contractInformation, List<ReservedSeatsTable> reservedSeats = null, int minimumSoftwareVersion = 1, Dictionary<string, object> blockHeaderToInitalize = null, string permission = "active");
