...
namespace BlockBase.Domain.Database.Sql.Generators
{
    public interface IGenerator
    {
        ...
        string BuildString(BeginStatement beginStatement);
        string BuildString(CommitStatement commitStatement);
        string BuildString(RollbackStatement rollbackStatement);
        ...
        string BuildString(TransactionStatement transactionStatement);
