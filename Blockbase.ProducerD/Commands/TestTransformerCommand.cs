...
namespace Blockbase.ProducerD.Commands
{
    class TestTransformerCommand : IHelperCommand
    {
        ...
        public async Task ExecuteAsync()
        {
            ...
            RunSqlCommand("CREATE TABLE table1 ( column1 ENCRYPTED 2 RANGE (2,10) PRIMARY KEY, column2 ENCRYPTED 2 NOT NULL);");
            ...
            RunSqlCommand("ALTER TABLE table1 RENAME TO newtable1");
            ...
            RunSqlCommand("INSERT INTO newtable1(column1, newcolumn2, !column3) VALUES ('pires', 'bulha', 7)");
